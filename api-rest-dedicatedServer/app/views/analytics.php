...
$sqlInterface = new SQLInterface('***REMOVED***', 'stats', '***REMOVED***', '***REMOVED***');

$results = $sqlInterface->getContent('visits', 0, 35000, 'time DESC');
?>
<head>
...
<body>
	...
	<div class="settings">
		...
		$content = [
			["Tout",""],
			["Assistant personnel","***REMOVED***"],
			["Dehash","***REMOVED***"],
			["Dysnomia","https://dysnomia.studio"],
			["Galactae (Site)","***REMOVED***"],
			["Galactae (Client de jeu)","Galactae (Client)"],
			["Gaspar","https://gaspar.ovh"],
			["Getiny Link","***REMOVED***"],
			["HowToOpenMe","https://howtoopen.me"],
			["Portfolio","***REMOVED***"],
			["Randomeme","***REMOVED***"],
			["Scifi","***REMOVED***"],
		];
		...
		function tri() {
			...
			for(var i=0; i<visits.length; i++) {
				...
				if(visits[i]["url"]!=undefined) {
					visits[i]["url"] = visits[i]["url"].replace("http://elanis","***REMOVED***");
					visits[i]["url"] = visits[i]["url"].replace("http://galactaewebsite","***REMOVED***");
					visits[i]["url"] = visits[i]["url"].replace("http://randomeme","***REMOVED***");
					visits[i]["url"] = visits[i]["url"].replace("http://gaspar","https://gaspar.ovh");
					visits[i]["url"] = visits[i]["url"].replace("http://liink","***REMOVED***");
					visits[i]["url"] = visits[i]["url"].replace("http://scifi","***REMOVED***");
					visits[i]["url"] = visits[i]["url"].replace("http://assistant_personnel","***REMOVED***");
					visits[i]["url"] = visits[i]["url"].replace("http://dehash-me","***REMOVED***");
					visits[i]["url"] = visits[i]["url"].replace("http://dysnomia","https://dysnomia.studio");
					visits[i]["url"] = visits[i]["url"].replace("http://howtoopenme","https://howtoopen.me");
				...
				if(visits[i]["origin"]!=undefined) {
					visits[i]["origin"] = visits[i]["origin"].replace("http://elanis","***REMOVED***");
					visits[i]["origin"] = visits[i]["origin"].replace("http://galactaewebsite","***REMOVED***");
					...
					visits[i]["origin"] = visits[i]["origin"].replace("http://randomeme","***REMOVED***");
					visits[i]["origin"] = visits[i]["origin"].replace("http://gaspar","https://gaspar.ovh");
					visits[i]["origin"] = visits[i]["origin"].replace("http://liink","***REMOVED***");
					visits[i]["origin"] = visits[i]["origin"].replace("http://scifi","https://scifi.elanistudio.eu");
					visits[i]["origin"] = visits[i]["origin"].replace("http://assistant_personnel","***REMOVED***");
					visits[i]["origin"] = visits[i]["origin"].replace("http://dehash-me","***REMOVED***");
					visits[i]["origin"] = visits[i]["origin"].replace("http://dysnomia","https://dysnomia.studio");
					visits[i]["origin"] = visits[i]["origin"].replace("http://howtoopenme","https://howtoopen.me");
